    ...
    if (isOpen) {
      ...
      if (editBuild) {
        ...
        setFormData({
          ...
          ivs: editBuild.ivs,
          evs: {
            hp: editBuild.evs.hp ?? 0,
            attack: editBuild.evs.attack ?? 0,
            defense: editBuild.evs.defense ?? 0,
            sp_attack: editBuild.evs.sp_attack ?? 0,
            sp_defense: editBuild.evs.sp_defense ?? 0,
            speed: editBuild.evs.speed ?? 0,
          },
      ...
      if (builds.length === 1) {
        ...
        setFormData({
          ...
          evs: {
            ...
            sp_attack: build.evs.sp_attack ?? 0,
            sp_defense: build.evs.sp_defense ?? 0,
